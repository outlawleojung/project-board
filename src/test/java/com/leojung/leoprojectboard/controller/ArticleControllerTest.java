package com.leojung.leoprojectboard.controller;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenNothing_whenRequestingArticlHashtagSearchView_thenReturnArticleHashtagSearchView() throws Exception {
